...
namespace zzzUnity.Burst.CodeGen
{
    ...
    internal class ILPostProcessing
    {
        ...
        private MethodDefinition CreateGetFunctionPointerDiscardMethod(TypeDefinition cls, FieldDefinition pointerField, MethodDefinition burstCompileMethod, MethodDefinition managedFallbackMethod, TypeDefinition injectedDelegate)
        {
            ...
            processor.Emit(OpCodes.Ldftn, managedFallbackMethod);
        ...
        private void ProcessMethodForDirectCall(MethodDefinition burstCompileMethod)
        {
            ...
            var getFunctionPointerDiscardMethod = CreateGetFunctionPointerDiscardMethod(cls, pointerField, burstCompileMethod, managedFallbackMethod, injectedDelegate);
